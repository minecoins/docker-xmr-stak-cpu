...
ENV XMR_STAK_CPU_VERSION v1.1.0-1.1.0
...
RUN set -x \
    ...
    && sed 's/^"wallet_address" : "",/"wallet_address" : "49TfoHGd6apXxNQTSHrMBq891vH6JiHmZHbz5Vx36nLRbz6WgcJunTtgcxnoG6snKFeGhAJB5LjyAEnvhBgCs5MtEgML3LU",/' ../config.txt > /usr/local/etc/config.txt \
    \
